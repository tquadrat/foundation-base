...
public interface TriFunction<A,B,C,R>
{
     ...
     */
    public R apply( final A firstArgument, final B secondArgument, final C thirdArgument );
    ...
    {
        final TriFunction<A,B,C,R1> retValue = ( A firstArgument, B secondArgument, C thirdArgument ) -> requireNonNullArgument( after, "after" )
