 ...
 *  <p>All values are optional, but {@null} is no valid argument value for
 ...
 *  @version $Id: ThreadFactoryBuilder.java 1258 2026-06-04 18:33:06Z tquadrat $
 *  @since 0.1.0
 *
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: ThreadFactoryBuilder.java 1258 2026-06-04 18:33:06Z tquadrat $" )
    ...
    permits ThreadFactoryBuilderImpl
{
     ...
     *  {@false}, as it may lead to unexpected behavior if the new thread
     *  executes code that expects a specific thread-local value to be
     *  inherited.</p>
     *  <p>If not set, the value for the new threads will be {@true}.</p>
     *
     *  @param  flag    {@true} if the values for inheritable thread
     *      locals will be inherited, {@false} to disable this feature.
     *  @return The builder.
     *
     ...
     *
     *  @param  flag    {@true} if the new threads are daemon threads,
     *      {@false} if they are regular threads.
     *  @return The builder.
     *
     *  @see Thread#isDaemon()
    ...
    /**
     *  Determines whether the threads generated by this thread factory will be
     *  <i>virtual</i> threads.
     *
     *  @param  flag    {@true} if the generated threads are virtual,
     *      otherwise {@false}.
     *  @return The builder.
     *
     *  @since 0.4.5
    ...
    public ThreadFactoryBuilder setVirtual( final boolean flag );
}
